  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <Label>
        ...
        <TextInput name="confirmPassword" type="password" autoComplete="true" disabled={isSubmitting} ref={register} />
      </Label>
      <SignUpButton type="submit" disabled={isSubmitting || !isValid}>Sign up</SignUpButton>
      <OrLogin>
        {" "}
